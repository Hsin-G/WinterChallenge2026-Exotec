...
static bool loadParamsJson(const string& filename) {
    ...
    unordered_map<string, double*> k = {
        ...
        {"TRAP_APPLE_EAT_PEN", &P.TRAP_APPLE_EAT_PEN},
        {"TRAP_APPLE_EVAL_PEN", &P.TRAP_APPLE_EVAL_PEN},
        {"TRAP_APPLE_HARD_PEN", &P.TRAP_APPLE_HARD_PEN},
        {"TRAP_APPLE_COMBO_PEN", &P.TRAP_APPLE_COMBO_PEN},
        {"GREEDY_APPLE_HEIGHT_BONUS", &P.GREEDY_APPLE_HEIGHT_BONUS},
        {"APPLE_HEIGHT_BONUS", &P.APPLE_HEIGHT_BONUS},
        {"FAST_APPLE_FALLBACK", &P.FAST_APPLE_FALLBACK},
        {"FAST_OPP_NEAR_APPLE", &P.FAST_OPP_NEAR_APPLE},
        {"FAST_TRAP_SEVERE", &P.FAST_TRAP_SEVERE},
        {"FAST_TRAP_MILD", &P.FAST_TRAP_MILD},
        {"FAST_TAIL_WINNING", &P.FAST_TAIL_WINNING},
        {"FAST_TAIL_NO_FOOD", &P.FAST_TAIL_NO_FOOD},
        {"FAST_TAIL_DEFAULT", &P.FAST_TAIL_DEFAULT},
        {"FAST_TAIL_SMALL_MULT", &P.FAST_TAIL_SMALL_MULT},
        {"FAST_HEAD_CLOSE_SMALLER", &P.FAST_HEAD_CLOSE_SMALLER},
        {"FAST_HEAD_CLOSE_BIGGER", &P.FAST_HEAD_CLOSE_BIGGER},
        {"FAST_HEAD_NEAR_SMALLER", &P.FAST_HEAD_NEAR_SMALLER},
        {"APPLE_RICH_APPLE_MULT", &P.APPLE_RICH_APPLE_MULT},
        {"APPLE_RICH_SPREAD_PEN", &P.APPLE_RICH_SPREAD_PEN},
        {"APPLE_RICH_SPREAD_DIST", &P.APPLE_RICH_SPREAD_DIST},
        {"APPLE_RICH_TERR_SCALE", &P.APPLE_RICH_TERR_SCALE},
        {"APPLE_RICH_CLOSEST_MULT", &P.APPLE_RICH_CLOSEST_MULT},
    };
